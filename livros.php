<?php
include 'config.php';
$sql = "SELECT l.id, l.titulo, l.ano, c.nome AS categoria FROM Livro l LEFT JOIN Categoria c ON l.id_categoria = c.id";
...
<body>
    <div class="container">
        <h2>Livros</h2>
        <table>
            <tr><th>ID</th><th>Título</th><th>Ano</th><th>Categoria</th></tr>
